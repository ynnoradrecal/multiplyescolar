				...
				<div class="top-icons col-md-8 col-sm-7 col-xs-12">
					...
					<nav class="top-bar text-center">
						...
						<ul>
							...
							<li class="link-menu hidden-xs"><a href="{{ url('/#como-funciona') }}" link="como-funciona" >COMO FUNCIONA?</a></li>
							<li class="link-menu hidden-xs"><a href="{{ url('/#sobre-nos') }}" link="sobre-nos" >SOBRE NÓS</a></li>
							<li class="link-menu hidden-xs"><a href="{{ url('/#contato') }}" link="contato" >CONTATO</a></li>
