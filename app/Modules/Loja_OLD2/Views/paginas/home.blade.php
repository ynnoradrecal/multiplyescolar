				...
				<div class="form-home">
					...
					<form id="homeForm" method="POST" action="contato" accept-charset="UTF-8">
						...
						<div class="form-group">
							<input class="btn btn-lg btn-blue pull-right" value="Enviar" type="submit">
						</div>
				...
				@for($i =0; $i < 1; $i++)
					...
					<div class="section-text-content">
						...
						<figure>
							...
							<img src="{{ asset('images') }}/aspas.png" class="img-responsive" />

						</figure>

						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Possimus iste optio amet exercitationem est labore architecto, repudiandae animi, dolorum neque aut sed quidem facere tempore eius debitis iusto omnis minus!</p>

						<span class="name-client">Lorem ipsum dolor</span>
		...
		<div class="container">
			...
			<div class="col-sm-8 col-sm-offset-2">
				...
				<div class="section-text-content">
					...
					<h3 class="text-center">CADASTRE-SE E RECEBA NOVIDADES</h3>
					<p class="text-center">Fique por dentro de todas as nossas novidades, cadastre-se agora mesmo</p>
