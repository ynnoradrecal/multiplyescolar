								...
								<table width="100%" style="background: #5ED7BB;">
									...
									<tr>
										...
										<td style="padding: 20px 10px">
											<h2 style="color: #fff; margin:0;" ><font face="arial,sans-serif">Há uma nova Ordem de Compra</font></h2>
										</td>
									</tr>									
								</table>
						...
						<tr>
							<td>
									...
									<table width="100%" cellpading="0" cellspacing="0" style="background: #fff; padding: 15px;">
										...
										@foreach ($pedidos as $pedido)
											...
											<tr>
												...
												<td>
													<font face="arial,sans-serif">{{ $pedido->titulo }}</font>
												</td>
								...
								<table  width="100%" cellpading="0" cellspacing="0" style="background: #000; color: #fff; padding: 8px; font-size: 13px;">
									<tr>
										<td class="text-center">
											<font face="arial,sans-serif">Fim da ordem de compra.</font>
										</td>
									</tr>
								</table>
