						...
						<tr>				
							<td>
								<table width="100%" style="background: #E22718;">
									...
									<tr>
										<td colspan="2" class="text-center" style="color: #fff; background: #B01F13; padding: 6px 0;">		
											<font face="arial,sans-serif">Olá, {{ $pedidos[0]->nome_cliente }} {{ $pedidos[0]->sobrenome_cliente }}.</font>
										</td>
									</tr>									
								</table>
									...
									<table width="100%" style="background: #fff; padding: 15px;">
										<tr>
											<td>
												...
												<h5 style="margin: 0;"><font face="arial,sans-serif">Seu pedido foi cancelado pelo Pagseguro, por favor entre em contato com seu banco para saber os motivos.</font></h5>
											</td>
										</tr>
									</table>								
