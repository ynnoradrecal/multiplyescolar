	...
	<section id="galnew">
		<div class="container">
			...
			<div class="footer row">
				...
				<div class="col-xs-12 text-right" style="position:relative;right:2px;">
		        	<button class="btn btn-primary redirect" redirect="{{ url('/') }}/photos-validate" role="button">
		        		PRÓXIMO <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
		        	</button>
		        </div>
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-body" style="position:relative;">
									...
									<div class="col-xs-12 nav-controll" style="position:absolute;top:50%;">
										<button type="button" class="btn btn-default prev nav-slider" style="position:absolute;top:0;left:-60px;">
											<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>
										</button>
										<button type="button" class="btn btn-default next nav-slider" style="position:absolute;top:0;right:-30px;">
