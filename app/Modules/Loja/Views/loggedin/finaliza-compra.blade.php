		...
		<div class="container">
			...
			<div class="row content">
							...
							<div class="col-xs-12">
								<table class="table"> 
									...
									<tfoot>
										<tr>
											<th>Desconto: </th>
											<td colspan="3" align="right">R$ <span>{{ $event->valor_do_desconto }}</span></td>
										</tr>
										<tr>
											<th>Total: </th>
				...
				<div class="col-md-6 col-sm-6 col-xs-12 payments">
					...
					<div class="col-xs-12 alert-pagamento" style="display:none;">
						<div class="alert alert-danger" role="alert">
							Verifique se todos os dados estão corretos.
							<strong>Informações pessoal, Endereço, Dados do pagamento</strong>
						</div>
					</div>
				...
				<div class="col-md-6 col-md-offset-6 col-xs-12 text-right">
					<div class="button">
						<div class="col-xs-6 text-left">
							<br>
							<a href="{{ url('/frete' ) }}"><i class="fa fa-reply"></i> SEÇÃO ANTERIOR</a>
						</div>
						<div class="col-xs-6 text-right">
							<button class="btn btn-success btn-lg" name="btn-checkout"><i class="fa fa-paper-plane-o"></i> PAGAMENTO</button>
						</div>
					</div>
				</div>
