	...
	<section id="sec-2">
		...
		<div id="sobre-nos" class="container">
			...
			<div class="col-md-5">
				...
				<h3>SOBRE NÓS</h3>
				<p>Fundada em São Caetano do Sul 1999, com uma forma inovadora e pioneira de trabalhar com Colégios, a Multiply abriu novas frentes através dos anos, até chegar na atual estrutura de empresa que compõe, 4 divisões especializadas em mercados diferentes da fotografia em um estúdio de 400m².</p>
				<ul class="check-list">
					<li>Casamento</li>
					<li>Empresas</li>
					<li>Colégios</li>
				...
				<p>Já são mais de 20.000 histórias eternizadas pela Multiply.<br>
