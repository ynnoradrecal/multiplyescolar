...
Route::group(['prefix' => '', 'namespace' => 'App\Modules\Loja\Controllers'], function () {
	...
	Route::group(['middleware' => ['web','loja.info']], function () {
		...
		Route::group(['middleware' => ['auth.cliente', 'carrinho.abandonado']], function () {
			...
			Route::get('/manutencao', 'FretesController@manutencao');
			...
			Route::post('/recuperar-cart', 'ClientesController@recuperarCart');
			Route::post('/del-cart-abandonado', 'ClientesController@delAbandonedCart');

			Route::get('/minha-conta/cart-abandonado', 'ClientesController@abandonedCart');
