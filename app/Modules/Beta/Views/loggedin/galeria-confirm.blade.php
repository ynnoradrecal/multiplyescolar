		...
		<div class="container">
				...
				<div class="col-xs-12">
					<div class="jumbotron" style="margin-bottom:5px;">
						...
						<div class="col-md-6 col-xs-6 text-left">
							<a href="{{ url('/') }}/beta/galerias/id/{{ $id_galeria }}"><i class="fa fa-reply"></i> SEÇÃO ANTERIOR</a>
						</div>
			...
			<div class="footer row">
	    		...
	    		<div class="col-xs-12 text-right">
	    			<div class="col-xs-12 text-right" >
	    				<a href="{{ url('/') }}/beta/galerias/id/{{ $id_galeria }}" class="btn btn-default">
	    					<span class="glyphicon glyphicon-picture" aria-hidden="true"></span> GALERIA
	    				</a>
	    				<a class="btn btn-primary" href="{{ url('/') }}/beta/settings-cart">
