	...
	<section id="breadcrumb">
		...
		<div class="container">
			...
			<div class="col-xs-12 text-center">
				...
				<small><b>Home</b> / Área do Cliente / Informações do Pedido </small>
											...
											<div class="col-md-6">
												<div class="price">
													...
													<span>
														...
														<h3>Valor dos Descontos</h3>
														R$ {{ number_format($pedido[0]->desconto, 2, ',', '.') }}<br>
											...
											<div class="col-md-12 itens">
												...
												@for($i = 0; $i < count($pedido); $i++)
													<div class="row" style="padding: 5px 0;">
														<div class="col-md-5">
															{{ $pedido[$i]->titulo }} {{ ( $pedido[$i]->name !== null )? ' ('. $pedido[$i]->name.')' : '' }}
														</div>
						...
						<div>
							<div class="">
								<a href="{{ url('').$fotos[$i]->url }}" data-lightbox="gallery" >
									<img src="{{ url('').$fotos[$i]->url }}" class="img-responsive" title="{{ $fotos[$i]->name }}" />
								</a>
							</div>
						</div>
					</li>
