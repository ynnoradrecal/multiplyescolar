								...
								<table width="100%" style="background: #5ED7BB;">
									...
									<tr>
										...
										<td style="padding: 20px 10px">
											<h2 style="color: #fff; margin:0;" ><font face="arial,sans-serif">Pagamento Confirmado</font></h2>
										</td>
									</tr>																		
									<tr>
									...
									<table width="100%" style="background: #fff; padding: 15px;">
										<tr>
											<td>
												...
												<h5 style="margin: 0;"><font face="arial,sans-serif">Seu pedido já está sendo separado. Para ver os detalhes do pedido acesse sua área de cliente.</font></h5>
											</td>
										</tr>
									</table>								
