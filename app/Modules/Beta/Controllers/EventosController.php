...
class EventosController extends Controller
{
	...
	public function index()
	{
		...
		return view("Beta::loggedin.eventos", compact('eventos'));
	...
	{		
		...
		return view("Beta::loggedin.repositorios", compact('repositorios', 'evento'));
	}
	...
	public function checkPin(Request $request)
	{
		...
		if ( true == boolval($gallery) )  {
			...
			return Response::json([
				...
				'url' => url("/").'/beta/galerias/id/'. $gallery->id
			], 200);
