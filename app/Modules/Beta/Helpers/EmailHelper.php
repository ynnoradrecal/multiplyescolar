...
class EmailHelper {
	...
	*/
	...
	public function sendPaymentCancelledEmail($to, $pedidos)
	{
		// array com as configurações de envio
		$sendData = [
			'view' => 'Loja::emails.pagamento-cancelado',
			'from' => 'site@multiply.com.br',
			'to' => $to,
			'subject' => 'Pedido Cancelado Nº: '.$pedidos[0]->num_pedido
		];
	...
	public function sendOrderCancelledAdminEmail($to, $pedidos)
	{
		// array com as configurações de envio
		$sendData = [
			'view' => 'Loja::emails.pagamento-cancelado-admin',
			'from' => 'site@multiply.com.br',
			'to' => $to,
			'subject' => 'Pedido Cancelado Nº: '.$pedidos[0]->num_pedido
		];
